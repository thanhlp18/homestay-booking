      ...
      rooms: [
        {
          ...
          bedrooms: 2,
          bathrooms: 1,
          features: ['Private garden', 'Quiet area', 'Secluded location', 'Peaceful environment'],
          policies: [
            'Nhận phòng từ 14:00',
            'Trả phòng trước 12:00',
            'Không hút thuốc trong phòng',
  ...
  for (const branchData of branches) {
    ...
    for (const roomData of branchData.rooms) {
      ...
      for (const timeSlotData of roomData.timeSlots) {
        ...
        console.log(`    ⏰ Created time slot: ${timeSlot.time} - ${timeSlot.price.toLocaleString('vi-VN')}đ`);
      }
    }
  }
