    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <h1 className={styles.pageTitle}>Chính sách bảo đảm</h1>
          <p className={styles.lastUpdated}>Cập nhật lần cuối: 15/01/2025</p>
        </div>

        <div className={styles.content}>
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>1. Cam kết chất lượng</h2>
            <p>
              Chúng tôi cam kết cung cấp dịch vụ chất lượng cao với các tiêu
              chuẩn sau:
            </p>
            <ul>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>2. Bảo đảm đặt phòng</h2>
            <div className={styles.guaranteeTypes}>
              <div className={styles.guaranteeType}>
                <h3>✅ Xác nhận ngay lập tức</h3>
                <p>
                  Nhận xác nhận đặt phòng ngay sau khi thanh toán thành công
                </p>
              </div>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>3. Chính sách hoàn tiền</h2>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>4. Quy trình khiếu nại</h2>
            <ol>
              ...
              <li>
                Nếu khiếu nại hợp lệ, sẽ được xử lý theo chính sách bảo đảm
              </li>
            </ol>
          </section>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>6. Bảo hiểm và an toàn</h2>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>7. Liên hệ khiếu nại</h2>
            <p>Để khiếu nại hoặc yêu cầu hỗ trợ, vui lòng liên hệ:</p>
            <div className={styles.contactInfo}>
              <p>
                <strong>Hotline khiếu nại:</strong> 0932000000
              </p>
              <p>
                <strong>Email:</strong> support@O Ni Homestay.vn
              </p>
              <p>
                <strong>Thời gian phản hồi:</strong> Trong vòng 2 giờ
              </p>
              <p>
